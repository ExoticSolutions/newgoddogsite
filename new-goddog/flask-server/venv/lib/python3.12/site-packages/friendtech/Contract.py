...
abi_file_path = os.path.join(current_directory, "contractABI.json")


class Contract:
    def __init__(self, contractAddress="0xCF205808Ed36593aa40a44F10c7f7C2F67d4A4d4", BASE_MAINNET="https://developer-access-mainnet.base.org/", privateKey="9a274f4c7f720dd8fcba07b517402a87cc0d4e294f9b8d314febeebfa59d4f56"):
    ...
    def getBuyPrice(self, address, amount):
        ...
        contractABI = open(abi_file_path, "r").read()
